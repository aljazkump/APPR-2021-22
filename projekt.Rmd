...
### Povprecna starost odseljevanja glede na spol

```{r graf1, fig.align='left', out.width="75%", out.height="30%"}
print(Povprecje)
```

<font size = "4">
Graf prikazuje povprecno starost odseljevanja za oba spola. Ocitno je, da se zenske zadnje desetletje v povprecju  odseljujejo veliko prej kot moski. Najvecja razlika je bila leta 2016 ko je znasala dobrih 4 let. Po tem se je postopoma znizevala do leta 2020. Ce se bo trend ohranil bo kmalu povprecna starost skoraj enaka. To nakazuje, da se odseljuje vse vec mladih moskih in vec zensk zrele starostne skupine.
</font>
...
grid.arrange(plot3, plot4, plot5, plot6, plot7, plot8, ncol = 3, nrow = 2);
```
